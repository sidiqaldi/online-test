          ...
          <tr v-for="exam in exams.data" :key="exam.uuid">
            ...
            <td class="align-middle">
              <div class="d-flex">
                ...
                <b-button align-self="end" class="mr-2 align-self-stretch" variant="outline-secondary" v-b-modal="'delete-' + exam.uuid"><icon name="trash" /> Hapus</b-button>
                <b-modal :id="'delete-' + exam.uuid" hide-backdrop title="Konfirmasi">
                  Hapus sesi <strong>{{ exam.name }}</strong>?
                  <p>
                  ...
                  <template v-slot:modal-footer>
                    <div class="w-100">
                      <b-button variant="secondary" size="sm" class="float-right mr-1" @click="deleteExam(exam.uuid)">Hapus</b-button>
                      <b-button variant="outline-secondary" size="sm" class="float-right mr-1" @click="$bvModal.hide('delete-' + exam.uuid)">Batal</b-button>
                    </div>
                  </template>
                </b-modal>
              </div>
