                  ...
                  <div class="col-md-6">
                    <b-row align-h="end">
                      <inertia-link
                        ...
                        class="btn btn-light"
                      >
                        <icon name="list-task" />Daftar Soal
                      </inertia-link>
                      <b-button
                        align-self="end"
                        variant="light"
                        v-b-modal="'delete-' + section.uuid"
                      >
                        ...
                        <template v-slot:modal-footer>
                          <div class="w-100">
                            ...
                            <b-button
                              ...
                              size="sm"
                              class="float-right mr-1"
                              @click="$bvModal.hide('delete-' + section.uuid)"
                            >Batal</b-button>
                          </div>
                        </template>
                      </b-modal>
                    ...
                    <div class="col-md-6">
                      <b-row align-h="end">
                        <inertia-link
                          ...
                          :href="$route('creator.sections.edit', section.uuid)"
                        >Edit</inertia-link>
                      </b-row>
                    </div>
                  </div>
...
export default {
  ...
  methods: {
    ...
    updateOrder(e) {
      if (e.moved) {
        this.$inertia.post(
          this.$route("creator.sections.order", e.moved.element.uuid),
          {
