  ...
  <layout :title="'Edit Pertanyaan - ' + $page.app.name" active="creator.exams.index">
    <template v-slot:header>
      <h3 class="d-inline">
        ...
        <inertia-link
          :href="$route('creator.questions.index', section.uuid)"
          type="submit"
        >{{ section.name }}</inertia-link>/
        Edit Soal
      </h3>
    </template>
        ...
        <div class="col-md-6 pl-3">
            ...
            <div class="col-md-8">
              <div class="form-group">
                ...
                <input
                  ...
                  :class="{ 'is-invalid' : $page.errors.question_title }"
                  placeholder="contoh: Soal #1 tentang penjumlahan sederhana"
                />
          ...
          <div v-for="(option, key) in form.options" :key="option.key" class="row mb-3">
            ...
            <div class="col-md-8 col-8">
              ...
              <span
                v-if="$page.errors['options.'+key+'.value']"
              ...
              <span
                v-if="$page.errors['options.'+key+'.image']"
                class="invalid-feedback"
                role="alert"
              >
            ...
            <div class="col-md-2 col-4 row">
              <b-button-group size="sm">
                <b-button
                  :variant="answer == option.key ? 'success' : 'outline-secondary'"
                  @click="correct(key)"
                >{{ answer == option.key ? 'Benar' : 'Salah' }}</b-button>
                <b-button
                  variant="outline-secondary"
                  @click.prevent="deleteOption(key)"
                  type="button"
                >
                  <icon name="trash" />
                </b-button>
...
export default {
  ...
  methods: {
    ...
    submit() {
      ...
      this.$inertia
        .put(
          this.$route("creator.questions.update", this.question.uuid),
          this.form
        )
